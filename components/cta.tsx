  ...
  return (
    <section id="contact" className="relative overflow-hidden scroll-mt-24">
      ...
      <div className="max-w6xl mx-auto px-4 sm:px-6">
        <div className="bg-linear-to-r from-transparent via-blue-900/30 py-12 md:py-20">
          <div className="mx-auto max-w-3xl text-center">
            <h2
              className="animate-[gradient_6s_linear_infinite] bg-[linear-gradient(to_right,var(--color-blue-200),var(--color-blue-400),var(--color-blue-100),var(--color-blue-500),var(--color-blue-200))] bg-[length:200%_auto] bg-clip-text pb-8 font-nacelle text-3xl font-semibold text-transparent md:text-4xl"
              data-aos="fade-up"
            >
              Accelerate your business growth — connect with us today.
            </h2>
